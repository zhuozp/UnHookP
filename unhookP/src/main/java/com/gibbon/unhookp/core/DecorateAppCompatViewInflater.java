...
/**
 * Created by zhipengzhuo on 2020/10/28 16:36
 */
public class DecorateAppCompatViewInflater {
    ...
    private void checkOnClickListener(View view, AttributeSet attrs) {
        ...
        if (handlerName != null) {
            view.setOnClickListener(new DecorateAppCompatViewInflater.DeclaredOnClickListener(view, handlerName));
        }
        a.recycle();
    }
